...
//                 System.out.println("Se alcanzaron %d invariantes\n\n", invariantes);
//                 if (invariantes >= 4) {
//                     setStop();
...
//         try (FileWriter writer = new FileWriter("logTransiciones.txt")) {
...
//         int cantidad = 0;
//         try {
//             System.out.println("Leyendo archivo antes de llamar a Python:");
//             java.nio.file.Files.lines(java.nio.file.Paths.get("../logTransiciones.txt")).forEach(System.out::println);

//             ProcessBuilder pb = new ProcessBuilder("python", "check_invariants.py", "../logTransiciones.txt");
