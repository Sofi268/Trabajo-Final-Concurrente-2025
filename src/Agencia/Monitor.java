...
// -------------------------------------------------------------------------------------------------
    ...
    */
    ...
    //         liberarMutex();
    //         if(finPrograma) {
    //             System.out.println("Programa finalizado, no se puede derivar a cola de condicion.");
    //             return; 
    //         }
    //         colasCondicion[t].acquire();
    //         System.out.println("Hilo de transicion " + t + " liberado de la cola.");
    //     } catch (InterruptedException e) {
    //         System.out.println("Error al derivar a cola de condicion para transicion " + t);
    //         e.printStackTrace();
    //     }
    // }
    private static void derivarAColaCondicion(int t) {
