...
public class Estadisticas implements Runnable {
    ...
    private void contarInvariantes() {
        try {
            ProcessBuilder pb = new ProcessBuilder("python3", "verificar_invariantes.py", "logTransiciones.txt");
            ...
            if (exitCode != 0) {
                System.err.println("El script Python terminó con error. Código: " + exitCode);
            }
    
        } catch (IOException | InterruptedException e) {
            System.err.println("Error al ejecutar el script de Python: " + e.getMessage());
            Thread.currentThread().interrupt();
        }
    }    
