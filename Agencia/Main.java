...
public class Main {
    ...
    public static void main(String[] args){
        ...
        Thread estadistica = new Thread();
        crearPuestos(hilos);
        iniciarPuestos(hilos);
        iniciarEstadisticas(estadistica);
        iniciarFinPrograma(hilos,estadistica);
	 ...
	 */
	private static void iniciarEstadisticas(Thread estadistica){
	...
	private static void iniciarFinPrograma(Thread[] hilos, Thread estadisticas) {
		FinDelPrograma fin = new FinDelPrograma(hilos, estadisticas);
		Thread finPrograma = new Thread(fin);
